...
import com.lind.common.minibase.DiskStore.DefaultCompactor;
import com.lind.common.minibase.DiskStore.DefaultFlusher;
...
/**
 * miniBase默认的实现. 最外层diskStore和memStore.
 */
public class MStore implements MiniBase {
	...
	static class ScanIter implements Iter<KeyValue> {
		...
		// Last KV is the last key value which has the largest sequence id in key values
		// with the
