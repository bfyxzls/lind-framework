...
public class BasicJsonwriter {
	...
	private void writeObjItem(String key, Object value, StringBuilder json) {
		...
		/*
		 * if ("serialVersionUID".equals(key) || value instanceof Logger) { // pass
		 *
		 * return; }
		 */
		...
		else if (value instanceof Boolean || value instanceof Short || value instanceof Integer || value instanceof Long
