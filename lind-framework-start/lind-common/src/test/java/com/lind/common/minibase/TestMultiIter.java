...
public class TestMultiIter {
	...
	public void testMergeSort3() throws IOException {
		...
		Assert.assertEquals(multiIter.next(), KeyValue.createPut(Bytes.toBytes("00001"), Bytes.toBytes("00001"), 1L));
		Assert.assertFalse(multiIter.hasNext());
	}
	...
	private void testDiskFileMergeSort(String[] inputs, String output, int rowCount) throws IOException {
		try {
