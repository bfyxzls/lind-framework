 ...
 * 使用：mybatis-plus，直接设置@TableField的typeHandler即可,而mybatis需要在xml文件中，对resultMap中的字段添加typeHandler
 */
...
public class ListTypeHandler implements TypeHandler<List> {
	...
	@Override
	public void setParameter(PreparedStatement preparedStatement, int i, List strings, JdbcType jdbcType)
			throws SQLException {
