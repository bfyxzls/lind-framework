...
package com.lind.codegen.support;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.CharsetUtil;
import cn.hutool.core.util.StrUtil;
import com.lind.codegen.CommonConstants;
import com.lind.codegen.entity.ColumnEntity;
import com.lind.codegen.entity.GenConfig;
import com.lind.codegen.entity.GenFormConf;
import com.lind.codegen.entity.TableEntity;
...
public class CodeGenKits {
	...
	private final String ENTITY_JAVA_VM = "template/Entity.java.vm";
	...
	public Map<String, String> generatorCode(GenConfig genConfig, Map<String, String> table,
		...
		for (Map<String, String> column : columns) {
			...
			// 判断注释是否为空
			if (StringUtils.isNotBlank(column.get("columnComment"))) {
				// 注意去除换行符号
	...
	public Configuration getConfig() {
		try {
			...
			throw new IllegalArgumentException("获取配置文件失败，", e);
		}
	}
