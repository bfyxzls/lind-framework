...
public class JsonSerialization {
	...
	/**
	 * Creates an {@link ObjectNode} based on the given {@code pojo}, copying all its
	 * properties to the resulting {@link ObjectNode}.
	 * @param pojo a pojo which properties will be populates into the resulting a
	 * {@link ObjectNode}
