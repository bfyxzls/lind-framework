...
public class HtmlUtilsTest {
	...
	static String str = "<div style='text-align:center;'> 整治“四风”   清弊<fdafd32除>垢<br/><span style='font-size:14px;'> </span><span style='font-size:18px;'>公司召开党的群众路线教育实践活动动员大会</span><br/></div>";

	@Test
	public void htmlDel() {
		System.out.println(HtmlUtils.getTextFromHtml(str));
		...
		String s = HtmlUtils.delHTMLTag(str2);
	...
	@Test
	public void escape() {
		str = HtmlUtils.escapeAttribute(str);
